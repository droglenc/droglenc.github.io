---
title: "Meyers Beach Lake Shore Trail"
subtitle: "Cornucopia, WI"
---

One of our favorite hikes is the [Lake Shore Trail](https://www.nps.gov/apis/planyourvisit/hiking.htm) at Meyers Beach in the Apostle Islands National Lakeshore. While often quite busy with other hikers it is still a nice hike above the sea caves along the Lake Superior shore. The views of The Crevasse, pillars, and The Bowl are always great.
...
# Make the walk
walkIDs <- c("WIMYRSLS01","WIMYRSLS02","WIMYRSLS03",
             "WIMYRSLS03","WIMYRSLS02","WIMYRSLS01")
