---
title: "Massacre Falls"
subtitle: "Massacre Grounds Trail"
---

On March 10, 2022 Kim and I hiked the Massacre Grounds trail to an impressive cliff and then to Massacre Falls. There was some water coming over the falls which was neat to see in the desert. Nice hike. Details are below.
...
# Make the walk
walkIDs <- c("MSCR01","MSCR02","MSCR02","MSCR03","MSCR03","MSCR01")
...
gpxhelpers::combineTracks2GPX(pin="c:/aaaPersonal/MAPPING/Tracks/Superstition Wilderness",
                              ...
                              fnm="SW_MassacreGrounds_2022.gpx",
                              IDs=unique(walkIDs))
