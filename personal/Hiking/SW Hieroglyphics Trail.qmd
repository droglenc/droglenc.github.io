...
On March 7, 2022 Kim and I hiked the Hieroglyphics Trail. This is a popular trail that goes to Hieroglyphics Canyon. A variety of petroglyhs can be seen on the canyon walls. Details are below.
...
# Make the walk
walkIDs <- c("HRGPH01","HRGPH02","HRGPH02","HRGPH01")
