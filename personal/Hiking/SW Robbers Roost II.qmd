...
Last year [I hiked to Robber's Roost via the Carney Springs Trail](SW Robbers Roost I.html). This year (February 16, 2024) Kim and I hiked to Robber's Roost via the Peralta Canyon Trail and Fremont Saddle. It was fun to share "the Roost" and the views out the fractures with Kim.
...
# Make the walk
walkIDs <- c("PRLTCN01","RDGLIN01","RBRRST01","RBRRST01","RDGLIN01",
             "GERCAV03","GERCAV02","GERCAV01","BLUFSP01","DTCHMN01")
