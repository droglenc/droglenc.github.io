---
title: "Hawk Ridge Snively Loop"
---

On November 22, 2022, [Cash](../shelties.html#cash) and I made a loop out of a hike along Hawk Ridge by coming back on the Snively Trail (via Colby Rd). This was a nice hike in the "middle" of the city. We did not take any pictures.
...
# Make the walk
walkIDs <- c("HWKRDG91","HWKRDG92","HWKRDG03","HWKRDG04","SNIVLY01",
             "CLBYAV01","HWKRDG01","HWKRDG93","HWKRDG91")
