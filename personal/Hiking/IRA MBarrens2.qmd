---
title: "Moquah Barrens Loop 2"
---

We have not made this hike yet, but it would be a good hike to see the typical but awesome barrens landscape of the Moquah Barrens. The southern border of this loop is on a fairly well-travelled forest road, whereas the other borders are on much less-traveled more off-road type forest roads. There is a power and pipe line corridor that traverses the southern third of the area, but it is not overly distracting. You can start in any of the four corners of the loop, but the NE corner is least easy to reach by truck. I started this hike in the SE corner as there is an easy parking area just across from where FR406 meets FR242. Further details are below.
...
# Make the walk
walkIDs <- c("FR24226","FR24225","FR24224","FR24223","FR407W01","FR407W02","FR407W03","FR44902","FR44903","FR44904","FR44905","FR44906","FR44907","FR44908","FR44909","FR40601","FR40602","FR40603","FR40604")
...
#| label: overviewMap
#| echo: false
gpxhelpers::allTracksMap(trkdat,clrs,walk=awalk,verbose=FALSE,map_bufr=0.0003)
```
