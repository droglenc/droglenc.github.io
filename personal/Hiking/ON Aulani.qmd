---
title: "Aulani Beach Trail"
subtitle: "Ko Olina, Oahu, HI"
---

On April 11 & 12, 2026, Kim had a conference at the [Aulani Disney Resort](https://www.disneyaulani.com/). In addition to lots of time in the hot tubs, good food, and swimming in the ocean, we walked the ocean-side trails from the resort. Nothing fancy, but still fun, especially getting to see a [Monk Seal](https://www.fisheries.noaa.gov/species/hawaiian-monk-seal).
...
# Make the walk
walkIDs <- c("AULANI01","AULANI02","AULANI04","AULANI04","AULANI03",
             "AULANI01","AULANI11","AULANI12","AULANI12","AULANI11")
