...
subitle: "The Backbone Trail"
---

Kim, [Cash](../shelties.html#cash), and I walked "The Backbone" in [Backbone State Park](https://www.iowadnr.gov/places-to-go/state-parks/iowa-state-parks/backbone-state-park) on 14-Jan-23. This is a short trail with the first half traversing a narrow set of limestone outcrops that form the "backbone." This section is quite beautiful with steep dropoffs on both sides to forks of the Maquoketa River. The second half of the trail is a broad loop through a largely hardwood forest that offers further views of the river. This is a "must-see" trail if you are in the park!
