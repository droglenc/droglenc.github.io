---
title: "Split Rock Shore to Day Hill"
subtitle: "Split Rock State Park"
---

On January 4, 2026, Kim, [Cash](../shelties.html#cash), and I hiked in [Split Rock Lighthouse State Park](https://www.dnr.state.mn.us/state_parks/park.html?id=spk00266#homepage) from the parking area on Highway 61, across 61 along the Lake Superior shoreline up to the Day Hill Lookout. This was a fun trail through a variety of habitats, including areas where the trail was close to Lake Superior. There is a neat set of stairs on the lake side of Day Hill and the view from Day Hill was beautiful, including a glimpse north to the Split Rock Lighthouse.
...
# Make the walk
walkIDs <- c("MNSPRKSH91","MNSPRKSH92","MNSPRKSH01","MNSPRKSH94","MNSPRKSH94",
             "MNSPRKSH02","MNSPRKSH03","MNSPRKSH96","MNSPRKSH96","MNSPRKSH04",
             "MNSPRKSH02","MNSPRKSH01","MNSPRKSH92","MNSPRKSH91")
