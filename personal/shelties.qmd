...
#| echo: false
#| results: hide
source("../zhelpers/makeCarousel.R")
```
...
#| echo: false
#| results: asis
makeCarousel(id="Cash",path="../zresources/img/Cash/",
...
#| echo: false
#| results: asis
makeCarousel(id="Jem",path="../zresources/img/Jem/",
...
#| echo: false
#| results: asis
makeCarousel(id="Jordan",path="../zresources/img/Jordan/",
             width=50,captions=FALSE,controls=FALSE)
```
