...
# Cash
We have had Cash since September 2020. He is a spirited "big pony" who loves to be outside, especially on [walks/hikes](hiking.html).

```{r}
#| echo: false
#| results: asis
gpxhelpers::makeCarousel(id="Cash",path="../zresources/img/Cash/",rev=TRUE,
