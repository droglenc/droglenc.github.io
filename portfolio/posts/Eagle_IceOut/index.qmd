...
- Range of ice-out dates is approximately eight weeks from `r sum$outEarlyDate` (in `r paste(outEarly$fyr,collapse=", ")`) to `r sum$outLateDate` (in `r paste(outLate$fyr,collapse=", ")`)  (see @fig-outhist).
...
```{r}
#| label: fig-out
#| fig-cap: Eagle Lake ice out dates by year. Note no data for 2008.
